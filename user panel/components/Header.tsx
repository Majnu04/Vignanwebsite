...
name: "Governance",
sub: [
{ name: 'Organizational Structure', link: '/governance/org-structure', image: '/images/core-structure.jpg' },
{ name: 'Governing Body', link: '/governance/governing-body', image: '/images/core-structure.jpg' },
{ name: 'Academic Council', link: '/governance/academic-council', image: '/images/core-structure.jpg' },
{ name: 'Finance Committee', link: '/governance/finance-committee', image: '/images/core-structure.jpg' },
{ name: 'Non Statutory Committees', link: '/committees', image: '/images/committees-default.jpg' }
]
}
]
},
...
link: '/admissions',
isMegaWithImage: true,
defaultImage: '/images/headerpics/admissions.jpeg',
sub: [
{
name: "Admission Process",
sub: [
{ name: 'Courses Offered', link: '/courses-offered', image: '/images/courses.jpg' },
{ name: 'Admissions Procedure', link: '/admissionsprocedure', image: '/images/procedure.jpg' },
{ name: 'Admission Lists', link: '/admissionslists', image: '/images/lists.jpg' },
{ name: 'Course Outcomes', link: '/admissionsoutcomes', image: '/images/outcomes.jpg' }
]
}
]
},
...
{
name: "Examinations",
image: '/images/headerpics/examinations.jpeg',
sub: [
{ name: 'About ExamCell', link: '/exams/about' },
{ name: 'Results', link: '/exams/results' },
{ name: 'Time Tables', link: '/exams/timetables' },
{ name: 'Notifications', link: '/exams/notifications' },
{ name: 'IT Reforms', link: '/exams/it-reforms' },
{ name: 'Examination Manual', link: '/exams/manual' }
]
}
]
},
...
{
name: 'Alumni',
link: 'https://alumni.vignaniit.edu.in/',
target: '_blank'
}
];
                ...
                <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'h-16' : 'h-16'}`}>
                    ...
                    <div className="flex items-center gap-x-6">
                        <div className="flex-shrink-0">
                            {/* Logo navigates to home page and plays video */}
                            <AnimatedLogo 
