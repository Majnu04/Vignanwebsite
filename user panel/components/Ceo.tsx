...
// --- Main CEO Message Page Component ---
const Ceo = () => {
    const [isHovered, setIsHovered] = useState(false);
    const [isMobile, setIsMobile] = useState(false);

    // Effect to handle responsive style changes on the client-side
    useEffect(() => {
    ...
    return (
        <>
            {/* --- FIX: @keyframes are now in a <style> tag --- */}
            <style>{`
                ...
                <div style={styles.mainContainer}>
                    ...
                    <div style={styles.container}>
                        <div style={styles.sidebar}>
                            ...
                            >
                                <img
                                    src="https://vignaniit.edu.in/images/CEO%20SIR%20copy.jpg"
                                    alt="Dr. Srikant Nandigam"
                                    style={styles.principalImage}
                                />
                            </div>
                            <div style={styles.principalInfo}>
                                <p style={styles.principalName}>Dr. Srikant Nandigam</p>
                                <p style={styles.principalTitle}>CEO,</p>
                        ...
                        <div style={styles.mainContent}>
                            <h1 style={styles.header}>CEO's Message</h1>
                            ...
                            <div style={styles.signature}>
                                <p style={styles.signatureName}>Dr. Srikant Nandigam (PhD)</p>
                                <p style={styles.principalTitle}>CEO,</p>
