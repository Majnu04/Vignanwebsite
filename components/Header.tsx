                            ...
                            {activeMenu && activeMenu.sub && (
                                <div className="flex">
                                    ...
                                    {activeMenu.isMegaWithImage && (
                                        <div className="w-2/5 relative p-10 pl-0" style={{ animation: `elegantCascade 0.6s 0.2s cubic-bezier(0.16, 1, 0.3, 1) forwards`, opacity: 0 }}>
