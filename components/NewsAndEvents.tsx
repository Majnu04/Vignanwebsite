    ...
    <section className={`relative w-full flex flex-col justify-center items-center overflow-hidden transition-all duration-1000 ease-in-out
      ...
      {isMobileView ? (
          ...
          <AnimatePresence initial={false}>
            ...
            >
              <img 
                ...
                className="absolute inset-0 w-full h-40 sm:h-48 object-cover"
                onError={(e) => {
        ...
        <>
          ...
          <div ref={constraintsRef} className="relative w-full max-w-4xl h-24 mt-12 cursor-grab active:cursor-grabbing bg-gray-50 rounded-lg p-2">
            <motion.div
