...
//         sidebarNavItems={cseSidebarData}
//         onBack={onBack}
//         sidebarClassName="bg-blue-800 text-white"
//       >
//         <article className="space-y-16">
...
//           {/* HOD MESSAGE SECTION - FONT STYLE UPDATED */}
//           <section id="hod-message" className="scroll-mt-24">
//             <h2 className="text-3xl font-bold text-blue-800 border-b-2 border-blue-200 pb-3 mb-4">
//               Message from the HOD
//             </h2>
...
//                 {/* UPDATED: Removed 'italic' class for a clean sans-serif font */}
//                 <p className="font-sans text-gray-800 leading-relaxed text-lg relative px-4">
//                   <span className="absolute top-0 left-0 text-7xl text-blue-200 font-serif -translate-y-4 opacity-70">“</span>
//                   {data.hodMessage}
//                   <span className="absolute bottom-0 right-0 text-7xl text-blue-200 font-serif translate-y-6 opacity-70">”</span>
//                 </p>
//                 <div className="mt-8">
//                     <p className="font-semibold text-blue-800 text-2xl" style={{ fontFamily: "'Dancing Script', cursive" }}>
//                       {data.hodName}
...
//           {/* FACULTY SECTION - TABLE COLORS UPDATED */}
//           <section id="faculty" className="scroll-mt-24">
//               <h2 className="text-3xl font-bold text-blue-800 border-b-2 border-blue-200 pb-3 mb-6">Our Faculty</h2>
//               {/* UPDATED: Wrapper div now has blue background and white text */}
//               <div className="overflow-x-auto bg-blue-800 text-white rounded-lg shadow-lg">
//                 <table className="min-w-full">
//                   {/* UPDATED: Thead has a darker blue background */}
//                   <thead className="bg-blue-900">
//                     <tr>
//                       <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase tracking-wider">S.No</th>
//                       <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase tracking-wider">Name of the Faculty</th>
//                       <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase tracking-wider">Designation</th>
//                     </tr>
//                   </thead>
//                   {/* UPDATED: Tbody has new background, divider color, and text colors */}
...
//                         <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{member.sno}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-50">{member.name}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-200">{member.designation}</td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
...
// // --- Main Page Component ---
// const CsePage: React.FC<{ data: any; onBack: () => void }> = ({ data, onBack}) => {
//   // REMOVED: The useEffect causing scroll issues is no longer needed.
//   // The layout now handles its own scrolling behavior correctly.
...
//   return (
//     // The main wrapper div is no longer needed as DepartmentLayout handles it.
//     <DepartmentLayout
//       departmentName={data.name}
//       heroImage={data.heroImage}
//       sidebarNavItems={cseSidebarData}
//       onBack={onBack}
//       sidebarClassName="bg-blue-800 text-white border-blue-700" // Pass custom theme to sidebar
//     >
//       <article className="space-y-16">
...
//         {/* VISION AND MISSION SECTION - UPDATED STYLE */}
//         <section id="vision" className="scroll-mt-24">
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
//               {/* Vision Card */}
...
//         {/* HOD MESSAGE SECTION - UPDATED STYLE */}
//         <section id="hod-message" className="scroll-mt-24">
//           <h2 className="text-3xl font-bold text-blue-800 border-b-2 border-blue-200 pb-3 mb-4">
//             Message from the HOD
//           </h2>
...
//               src={data.hodImage}
//               alt={`HOD ${data.hodName}`}
//               className="w-48 h-64 rounded-lg object-cover shadow-lg shrink-0 border-4 border-white"
//             />
//             <div className="w-full text-center">
//               {/* REMOVED: 'italic' class for a cleaner sans-serif font */}
//               <p className="font-sans text-gray-800 leading-relaxed text-lg relative px-4">
//                 <span className="absolute top-0 left-0 text-7xl text-blue-200 font-serif -translate-y-4 opacity-70">“</span>
//                 {data.hodMessage}
//                 <span className="absolute bottom-0 right-0 text-7xl text-blue-200 font-serif translate-y-6 opacity-70">”</span>
...
//         {/* FACULTY SECTION - UPDATED STYLE */}
//         <section id="faculty" className="scroll-mt-24">
//             <h2 className="text-3xl font-bold text-blue-800 border-b-2 border-blue-200 pb-3 mb-6">Our Faculty</h2>
//             {/* Wrapper div now has blue background and white text */}
//             <div className="overflow-x-auto bg-blue-800 text-white rounded-lg shadow-lg">
//               <table className="min-w-full">
//                 {/* Thead has a darker blue background */}
//                 <thead className="bg-blue-900">
//                   <tr>
//                     <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase tracking-wider">S.No</th>
//                     <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase tracking-wider">Name of the Faculty</th>
...
//                   </tr>
//                 </thead>
//                 {/* Tbody has new background, divider color, and text colors */}
//                 <tbody className="bg-blue-800 divide-y divide-blue-700">
//                   {data.faculty?.map((member: any, index: number) => (
//                     <tr key={index} className="hover:bg-blue-700 transition-colors duration-200">
//                       <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{member.sno}</td>
